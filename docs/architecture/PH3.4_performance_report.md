# Platform Performance Report (PH3.1 / PH3.2 / PH3.3 / PH3.4)

**Source:** `outputs/pipeline.trace.json`

## Pipeline totals

| Metric | Value |
|---|--:|
| Pipeline wall time | 18,010 ms |
| LLM generation | 0 ms (0.0%) |
| Non-LLM | 18,010 ms (100.0%) |
| LLM calls | 0 |
...
|---|--:|--:|--:|--:|--:|--:|
| EvidenceAgent | 17,845 | 0 | 17,845 | 0.0 | 0 | 0 |
| ReportAgent | 32 | 0 | 32 | 0.0 | 0 | 0 |
| RiskAgent | 26 | 0 | 26 | 0.0 | 0 | 0 |
| AssumptionAgent | 22 | 0 | 22 | 0.0 | 0 | 0 |
| DecisionAnalysisAgent | 22 | 0 | 22 | 0.0 | 0 | 0 |
| OpportunityAgent | 21 | 0 | 21 | 0.0 | 0 | 0 |
| ExecutiveConfidenceAgent | 21 | 0 | 21 | 0.0 | 0 | 0 |
...
| _unattributed_ | 18,010 ms |

## Largest bottlenecks

**By agent (wall time):**

1. EvidenceAgent — 17,845 ms (LLM 0 / non-LLM 17,845)
2. ReportAgent — 32 ms (LLM 0 / non-LLM 32)
3. RiskAgent — 26 ms (LLM 0 / non-LLM 26)
4. AssumptionAgent — 22 ms (LLM 0 / non-LLM 22)
5. DecisionAnalysisAgent — 22 ms (LLM 0 / non-LLM 22)
